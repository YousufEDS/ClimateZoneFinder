...
#                 <h2 style="color: {strategies_data['color']}; font-size: 36px; margin-bottom: 10px;">{strategies_data['title']}</h2>
#                 <p style="color: #666; font-size: 18px; margin-bottom: 40px;">Passive Design Strategies</p>
#             </div>
#         """, unsafe_allow_html=True)
        
#         # Display strategies in a three-column layout
...
#                         <h3 style="color: #333; font-size: 24px; margin-bottom: 15px;">{strategy['name']}</h3>
#                     </div>
#                 """, unsafe_allow_html=True)
...
#                         st.markdown(f"""
#                             <div style="background-color: #f0f0f0; padding: 60px 40px; border-radius: 10px; text-align: center; margin-bottom: 20px; border: 2px dashed #ccc;">
#                                 <p style="color: #999; font-size: 16px; margin: 0;">📷 Image Placeholder</p>
#                                 <p style="color: #bbb; font-size: 13px; margin-top: 10px; font-style: italic;">{strategy.get('image', 'No path specified')}</p>
#                             </div>
#                         """, unsafe_allow_html=True)
#                 else:
#                     # No image specified
#                     st.markdown("""
#                         <div style="background-color: #f0f0f0; padding: 60px 40px; border-radius: 10px; text-align: center; margin-bottom: 20px; border: 2px dashed #ccc;">
#                             <p style="color: #999; font-size: 16px; margin: 0;">📷 Image will be added</p>
#                         </div>
#                     """, unsafe_allow_html=True)
                
#                 st.markdown(f"""
#                     <div style="background-color: #f8f9fa; padding: 20px; border-radius: 8px; border-left: 4px solid {strategies_data['color']};">
#                         <p style="color: #555; font-size: 16px; line-height: 1.6; margin: 0;">{strategy['description']}</p>
#                     </div>
#                 """, unsafe_allow_html=True)
